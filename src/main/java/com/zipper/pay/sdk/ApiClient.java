...
import com.zipper.pay.sdk.auth.Authentication;
import com.zipper.pay.sdk.auth.HttpBasicAuth;
import com.zipper.pay.sdk.auth.HttpBearerAuth;
import com.zipper.pay.sdk.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "http://localhost:8089";
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8089
     ...
     * @return a {@link com.zipper.pay.sdk.ApiClient} object
     */
    ...
    */
     ...
     * @throws com.zipper.pay.sdk.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws com.zipper.pay.sdk.ApiException If fail to serialize the given object
     */
     ...
     * @throws com.zipper.pay.sdk.ApiException If fail to read file content from response and write to disk
     ...
     * @throws com.zipper.pay.sdk.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws com.zipper.pay.sdk.ApiException If the response has an unsuccessful status code or
     ...
     * @throws com.zipper.pay.sdk.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws com.zipper.pay.sdk.ApiException If fails to update the parameters
     */
     ...
     * @throws com.zipper.pay.sdk.ApiException If fail to serialize the request body object into a string
     */
